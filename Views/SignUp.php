<article class="col-12 col-md-10 col-xl-8 offset-md-1 offset-xl-2 py-5">
    ...
    <form id="signUp-form" class="p-5">
        <div class="d-flex">
            ...
            <input id="signUp-confirm" class="w-33 btn rounded-right button-normal" type="button" value="<?= $parameters["getText"]("signUp-confirm"); ?>"/>
        </div>
        ...
        <input class="w-100 btn rounded-pill button-normal" type="submit" value="<?= $parameters["getText"]("signUp-submit"); ?>"/>
    </form>
</article>