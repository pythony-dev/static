    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content px-4 py-5">
            ...
            <form id="create-form" class="p-4">
                ...
                <button id="create-add" class="w-100 mt-4 btn btn-outline-primary" type="button"> <?= $parameters["getText"]("create-add"); ?> </button>
                ...
                <input class="w-100 mt-4 btn btn-primary" type="submit" value="<?= $parameters["getText"]("create-submit"); ?>"/>
