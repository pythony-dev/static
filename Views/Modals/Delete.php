    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content px-4 py-5">
            ...
            <form id="delete-form" class="p-4">
                <input id="delete-confirm" class="form-control text-center" type="password" placeholder="<?= $parameters["getText"]("delete-confirm"); ?>" required/>
                <input class="w-100 mt-4 btn btn-danger" type="submit" value="<?= $parameters["getText"]("delete-submit"); ?>"/>
